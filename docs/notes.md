...
Windows -> Windows
┌───────────────────┬───────────────────┬────────────────┬───────────────┬─────────────────┬───────────────────┐
│ Method            │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync.exe (x5) │ 2.59s - 2.95s     │ 125ms - 162ms  │ 164ms - 247ms │ 2.93s - 3.41s   │ 405ms - 717ms     │
│ scp (x5)          │ 2.46s - 2.81s     │ Skipped        │ Skipped       │ Skipped         │ 402ms - 442ms     │
│ xcopy (x5)        │ 2.44s - 2.83s     │ Skipped        │ Skipped       │ Skipped         │ 369ms - 479ms     │
│ robocopy (x5)     │ 2.02s - 2.38s     │ 90ms - 92ms    │ 228ms - 233ms │ 2.83s - 3.01s   │ 371ms - 380ms     │
│ APIs (x5)         │ 1.92s - 2.35s     │ Skipped        │ Skipped       │ Skipped         │ 361ms - 373ms     │
└───────────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
...
│ Method            │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync.exe (x5) │ 7.40s - 8.22s     │ 492ms - 498ms  │ 544ms - 567ms │ 10.30s - 11.47s │ 5.45s - 5.58s     │
│ scp (x5)          │ 22.02s - 22.40s   │ Skipped        │ Skipped       │ Skipped         │ 2.72s - 2.76s     │
│ xcopy (x5)        │ 22.03s - 22.71s   │ Skipped        │ Skipped       │ Skipped         │ 2.71s - 2.74s     │
│ robocopy (x5)     │ 11.94s - 12.01s   │ 841ms - 858ms  │ 941ms - 958ms │ 17.29s - 17.62s │ 2.72s - 2.77s     │
│ APIs (x5)         │ 8.18s - 8.37s     │ Skipped        │ Skipped       │ Skipped         │ 2.71s - 2.78s     │
└───────────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
...
│ Method            │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync.exe (x5) │ 3.03s - 3.48s     │ 425ms - 540ms  │ 256ms - 403ms │ 2.97s - 3.50s   │ 2.63s - 3.17s     │
│ scp (x5)          │ 4.53s - 5.22s     │ Skipped        │ Skipped       │ Skipped         │ 4.81s - 4.93s     │
└───────────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
...
│ Method            │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync.exe (x5) │ 1.35s - 2.14s     │ 1.08s - 1.51s  │ 947ms - 1.52s │ 1.25s - 1.40s   │ 3.02s - 3.67s     │
│ scp (x5)          │ 16.98s - 23.52s   │ Skipped        │ Skipped       │ Skipped         │ 5.67s - 5.77s     │
└───────────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
...
│ Method        │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync (x5) │ 201ms - 222ms     │ 40ms - 46ms    │ 211ms - 261ms │ 191ms - 208ms   │ 418ms - 500ms     │
│ rsync (x5)    │ 184ms - 207ms     │ 23ms - 30ms    │ 43ms - 50ms   │ 234ms - 254ms   │ 1.84s - 1.95s     │
│ scp (x5)      │ 86ms - 95ms       │ Skipped        │ Skipped       │ Skipped         │ 424ms - 488ms     │
│ cp (x5)       │ 87ms - 124ms      │ Skipped        │ Skipped       │ Skipped         │ 411ms - 486ms     │
│ APIs (x5)     │ 90ms - 101ms      │ Skipped        │ Skipped       │ Skipped         │ 375ms - 436ms     │
└───────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
...
│ Method        │ Everything copied │ Nothing copied  │ Some copied     │ Delete and copy │ Single large file │
├───────────────┼───────────────────┼─────────────────┼─────────────────┼─────────────────┼───────────────────┤
│ rjrssync (x5) │ 13.92s - 15.98s   │ 14.74s - 16.70s │ 15.32s - 17.11s │ 26.08s - 29.44s │ 3.88s - 4.00s     │
│ rsync (x5)    │ 39.26s - 39.87s   │ 22.48s - 24.80s │ 24.34s - 25.13s │ 46.74s - 48.90s │ 5.02s - 5.69s     │
│ scp (x5)      │ 15.35s - 16.71s   │ Skipped         │ Skipped         │ Skipped         │ 4.36s - 4.69s     │
│ cp (x5)       │ 15.04s - 15.65s   │ Skipped         │ Skipped         │ Skipped         │ 4.59s - 4.66s     │
│ APIs (x5)     │ 15.85s - 16.35s   │ Skipped         │ Skipped         │ Skipped         │ 5.22s - 5.28s     │
└───────────────┴───────────────────┴─────────────────┴─────────────────┴─────────────────┴───────────────────┘
...
│ Method        │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync (x5) │ 3.28s - 3.62s     │ 342ms - 777ms  │ 2.97s - 3.14s │ 3.51s - 4.18s   │ 2.42s - 2.57s     │
│ scp (x5)      │ 5.04s - 5.52s     │ Skipped        │ Skipped       │ Skipped         │ 4.54s - 4.75s     │
└───────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
...
│ Method        │ Everything copied │ Nothing copied │ Some copied   │ Delete and copy │ Single large file │
├───────────────┼───────────────────┼────────────────┼───────────────┼─────────────────┼───────────────────┤
│ rjrssync (x5) │ 539ms - 600ms     │ 314ms - 360ms  │ 532ms - 599ms │ 530ms - 600ms   │ 1.70s - 1.80s     │
│ rsync (x5)    │ 521ms - 608ms     │ 304ms - 331ms  │ 349ms - 371ms │ 591ms - 630ms   │ 3.75s - 3.85s     │
│ scp (x5)      │ 1.64s - 1.77s     │ Skipped        │ Skipped       │ Skipped         │ 4.24s - 4.50s     │
└───────────────┴───────────────────┴────────────────┴───────────────┴─────────────────┴───────────────────┘
