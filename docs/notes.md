...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 579.3534ms        │ 52.9134ms      │ 675.9945ms  │ 1.1839889s        │
│ rsync    │ 294.1217ms        │ 40.1ms         │ 44.1843ms   │ 3.1293798s        │
│ scp      │ 120.2796ms        │ 125.0647ms     │ 106.9955ms  │ 578.207ms         │
│ cp       │ 127.9499ms        │ 127.6941ms     │ 123.721ms   │ 536.0887ms        │
│ APIs     │ 107.3867ms        │ 132.4896ms     │ 135.0038ms  │ 458.9056ms        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 30.2554667s       │ 29.6569021s    │ 29.8633488s │ 5.8040741s        │
│ rsync    │ 49.0622579s       │ 31.23026s      │ 29.309787s  │ 6.4714167s        │
│ scp      │ 18.2695055s       │ 19.9009666s    │ 19.3980181s │ 5.5389662s        │
│ cp       │ 17.919262s        │ 19.7093926s    │ 19.3832782s │ 5.1310872s        │
│ APIs     │ 18.1032011s       │ 16.9165951s    │ 16.7407832s │ 5.8633283s        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file   │
├──────────┼───────────────────┼────────────────┼─────────────┼─────────────────────┤
│ rjrssync │ 6.1649069s        │ 639.1588ms     │ 5.2841542s  │ Skipping (crashes!) │
│ scp      │ 6.7386644s        │ 6.5569432s     │ 6.8483209s  │ 5.726743s           │
└──────────┴───────────────────┴────────────────┴─────────────┴─────────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 1.5219531s        │ 472.8823ms     │ 1.2122695s  │ 8.9482995s        │
│ rsync    │ 775.0987ms        │ 401.874ms      │ 414.3633ms  │ 4.7719859s        │
│ scp      │ 2.1597887s        │ 1.8954931s     │ 1.8659648s  │ 4.7948466s        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
