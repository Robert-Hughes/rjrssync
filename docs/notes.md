...
Disabling unicode feature in regex (and removing regex feature from env_logger): 5.6 -> 5.0, however this caused problems as "\d" in regexes didn't work, so maybe we can't disable this feature :(
