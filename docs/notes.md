...
├──────────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync.exe │ 4.3274953s        │ 180.3479ms     │ 206.1509ms  │ 850.673ms         │
│ scp          │ 3.4230439s        │ 2.5924149s     │ 2.6875998s  │ 457.94ms          │
│ xcopy        │ 3.1631932s        │ 2.389903s      │ 2.2927495s  │ 402.1073ms        │
│ robocopy     │ 2.4888901s        │ 101.1915ms     │ 247.9325ms  │ 673.311ms         │
│ APIs         │ 2.1538086s        │ 1.9763266s     │ 16.0370529s │ 410.6656ms        │
└──────────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method       │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync.exe │ 8.9410944s        │ 548.392ms      │ 756.998ms   │ 6.8392168s        │
│ scp          │ 23.4584917s       │ 23.8276281s    │ 24.3476736s │ 3.2850678s        │
│ xcopy        │ 24.8456811s       │ 24.5338645s    │ 25.7340833s │ 3.1944097s        │
│ robocopy     │ 14.3375861s       │ 900.7248ms     │ 1.0063658s  │ 2.9536302s        │
│ APIs         │ 9.0325625s        │ 8.8182088s     │ 8.8056322s  │ 3.1724281s        │
└──────────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method       │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync.exe │ 4.1884907s        │ 813.0536ms     │ 315.5936ms  │ 3.9398266s        │
│ scp          │ 5.5642134s        │ 5.9653143s     │ 5.0377275s  │ 5.4506868s        │
└──────────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method       │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync.exe │ 25.4812376s       │ 1.4535017s     │ 1.3255571s  │ 13.3881664s       │
│ scp          │ 13.6966747s       │ 14.2872855s    │ 13.5519746s │ 6.2085998s        │
└──────────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 482.8628ms        │ 58.57ms        │ 450.63ms    │ 565.4585ms        │
│ rsync    │ 203.0923ms        │ 26.7593ms      │ 35.2097ms   │ 2.0677382s        │
│ scp      │ 109.8251ms        │ 93.5932ms      │ 96.9922ms   │ 560.7526ms        │
│ cp       │ 92.5387ms         │ 90.0417ms      │ 89.5667ms   │ 432.3683ms        │
│ APIs     │ 105.8891ms        │ 154.4116ms     │ 143.5837ms  │ 467.3202ms        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 14.4996942s       │ 16.7048718s    │ 19.195223s  │ 4.3650701s        │
│ rsync    │ 42.5510283s       │ 27.814998s     │ 28.0790241s │ 6.1881465s        │
│ scp      │ 17.9013067s       │ 19.5410248s    │ 19.5052243s │ 4.8849933s        │
│ cp       │ 17.6329799s       │ 20.9240795s    │ 19.1813484s │ 4.8268893s        │
│ APIs     │ 17.2191425s       │ 16.6079021s    │ 16.6998242s │ 4.7687684s        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 5.20029s          │ 349.2599ms     │ 4.7913925s  │ 3.9072748s        │
│ scp      │ 6.2648926s        │ 5.6135163s     │ 5.4727379s  │ 4.9141229s        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
...
│ Method   │ Everything copied │ Nothing copied │ Some copied │ Single large file │
├──────────┼───────────────────┼────────────────┼─────────────┼───────────────────┤
│ rjrssync │ 1.0374873s        │ 406.5371ms     │ 1.0157367s  │ 3.3387583s        │
│ rsync    │ 649.9523ms        │ 343.2985ms     │ 370.6332ms  │ 4.4412654s        │
│ scp      │ 1.7701566s        │ 1.8736347s     │ 1.7548129s  │ 4.4815019s        │
└──────────┴───────────────────┴────────────────┴─────────────┴───────────────────┘
